...
input bool MN = true;//trade on M< timeFrame
...
input double tp4 = 100, sl4 = 100;

//
string M1_Signal, M5_Signal, M15_Signal, H1_Signal, H4_Signal, D1_Signal, W1_Signal, MN_Signal;
      ...
      if(M1)
        {
         ...
         if(open.GetData(2) > Ma1M1.Main(2) && open.GetData(1) > Ma1M1.Main(1)
           ...
           {
            Buy(magicM1, BuyM1, SellM1, lastBuyM1, lastSellM1);
            dash.Set_M1_Signal("Buy");
           }
         // sell
         if(open.GetData(2) < Ma2M1.Main(2) && open.GetData(1) < Ma2M1.Main(1)
            && close.GetData(2) < Ma2M1.Main(2) && close.GetData(1) < Ma2M1.Main(1)
            && high.GetData(2) < Ma2M1.Main(2) && high.GetData(1) < Ma2M1.Main(1))
           {
            Sell(magicM1, BuyM1, SellM1, lastBuyM1, lastSellM1);
      ...
      if(M5)
        {
         ...
         if(open.GetData(2) > Ma1M5.Main(2) && open.GetData(1) > Ma1M5.Main(1)
            ...
            && low.GetData(2) > Ma1M5.Main(2) && low.GetData(1) > Ma1M5.Main(1))
           {
            ...
            Buy(magicM5, BuyM5, SellM5, lastBuyM5, lastSellM5);
           }
         // sell
         if(open.GetData(2) < Ma2M5.Main(2) && open.GetData(1) < Ma2M5.Main(1)
            && close.GetData(2) < Ma2M5.Main(2) && close.GetData(1) < Ma2M5.Main(1)
            && high.GetData(2) < Ma2M5.Main(2) && high.GetData(1) < Ma2M5.Main(1))
           {
            Sell(magicM5, BuyM5, SellM5, lastBuyM5, lastSellM5);
      ...
      if(M15)
        {
         ...
         if(open.GetData(2) > Ma1M15.Main(2) && open.GetData(1) > Ma1M15.Main(1)
           ...
           {
            Buy(magicM15, BuyM15, SellM15, lastBuyM15, lastSellM15);
         ...
         if(open.GetData(2) < Ma2M15.Main(2) && open.GetData(1) < Ma2M15.Main(1)
           ...
           {
            Sell(magicM15, BuyM15, SellM15, lastBuyM15, lastSellM15);
      ...
      if(M30)
        {
         ...
         if(open.GetData(2) > Ma1M30.Main(2) && open.GetData(1) > Ma1M30.Main(1)
           ...
           {
            Buy(magicM30, BuyM30, SellM30, lastBuyM30, lastSellM30);
         ...
         if(open.GetData(2) < Ma2M30.Main(2) && open.GetData(1) < Ma2M30.Main(1)
           ...
           {
            Sell(magicM30, BuyM30, SellM30, lastBuyM30, lastSellM30);
      ...
      if(H1)
        {
         ...
         if(open.GetData(2) > Ma1H1.Main(2) && open.GetData(1) > Ma1H1.Main(1)
           ...
           {
            Buy(magicH1, BuyH1, SellH1, lastBuyH1, lastSellH1);
         ...
         if(open.GetData(2) < Ma2H1.Main(2) && open.GetData(1) < Ma2H1.Main(1)
           ...
           {
            Sell(magicH1, BuyH1, SellH1, lastBuyH1, lastSellH1);
      ...
      if(H4)
        {
         ...
         if(open.GetData(2) > Ma1H4.Main(2) && open.GetData(1) > Ma1H4.Main(1)
           ...
           {
            Buy(magicH4, BuyH4, SellH4, lastBuyH4, lastSellH4);
         ...
         if(open.GetData(2) < Ma2H4.Main(2) && open.GetData(1) < Ma2H4.Main(1)
           ...
           {
            Sell(magicH4, BuyH4, SellH4, lastBuyH4, lastSellH4);
      ...
      if(D1)
        {
         ...
         if(open.GetData(2) > Ma1D1.Main(2) && open.GetData(1) > Ma1D1.Main(1)
           ...
           {
            Buy(magicD1, BuyD1, SellD1, lastBuyD1, lastSellD1);
         ...
         if(open.GetData(2) < Ma2D1.Main(2) && open.GetData(1) < Ma2D1.Main(1)
           ...
           {
            Sell(magicD1, BuyD1, SellD1, lastBuyD1, lastSellD1);
      ...
      if(W1)
        {
         ...
         if(open.GetData(2) > Ma1W1.Main(2) && open.GetData(1) > Ma1W1.Main(1)
           ...
           {
            Buy(magicW1, BuyW1, SellW1, lastBuyW1, lastSellW1);
         ...
         if(open.GetData(2) < Ma2W1.Main(2) && open.GetData(1) < Ma2W1.Main(1)
           ...
           {
            Sell(magicW1, BuyW1, SellW1, lastBuyW1, lastSellW1);
      ...
      if(MN)
        {
         ...
         if(open.GetData(2) > Ma1MN.Main(2) && open.GetData(1) > Ma1MN.Main(1)
           ...
           {
            Buy(magicMN, BuyMN, SellMN, lastBuyMN, lastSellMN);
         ...
         if(open.GetData(2) < Ma2MN.Main(2) && open.GetData(1) < Ma2MN.Main(1)
           ...
           {
            Sell(magicMN, BuyMN, SellMN, lastBuyMN, lastSellMN);
...
//+------------------------------------------------------------------+
//+------------------------------------------------------------------+
void Sell(long magic, CPosition &posBuy, CPosition &posSell, datetime& lastBuyConditionTime, datetime& lastSellConditionTime)
  {
   if(tools.IsNewBar() && posBuy.GroupTotal() < 1 && posSell.GroupTotal() == 0)
     {
         ...
         if(buyAndSell || sellOnly)
           {
            ...
            trade.Position(TYPE_POSITION_SELL, lot4, sl4, tp4, SLTP_PIPS, 15, (string)magic);
            if(AlertNotify)
              {
...
//|  www.yousufmesalm.com | WhatsApp +201006179048 | Upwork: https://www.upwork.com/freelancers/youssefmesalm |
//+------------------------------------------------------------------+
void Buy(long magic, CPosition &posBuy, CPosition &posSell, datetime& lastBuyConditionTime, datetime& lastSellConditionTime)
  {
   if(tools.IsNewBar() && posBuy.GroupTotal() == 0 && posSell.GroupTotal() == 0)
     {
      if(lastBuyConditionTime <= lastSellConditionTime)
        {
         if(buyAndSell || buyonly)
           {
            ...
            trade.Position(TYPE_POSITION_BUY, lot4, sl4, tp4, SLTP_PIPS, 15, (string)magic);
            if(AlertNotify)
              {
